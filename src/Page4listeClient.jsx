            ...
            <div className="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5 dark:bg-gray-800 dark:border-gray-700">
              <div className="w-full mb-1">
                <div className="mb-4">
                  ...
                  <h1 className="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">All Clients</h1>
                </div>
                      ...
                      <tbody className="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                        <tr className="hover:bg-gray-100 dark:hover:bg-gray-700">
                          ...
                          <td className="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap">
                            ...
                            <div className="text-sm font-normal text-gray-500 dark:text-gray-400">
                              <div className="text-base font-semibold text-gray-900 dark:text-white">Neil Sims</div>
                              <div className="text-sm font-normal text-gray-500 dark:text-gray-400">neil.sims@flowbite.com</div>
                            </div>
                          </td>
                        ...
                        <tr className="hover:bg-gray-100 dark:hover:bg-gray-700">
                          ...
                          <td className="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap">
                            ...
                            />
                            <div className="text-sm font-normal text-gray-500 dark:text-gray-400">
                              <div className="text-base font-semibold text-gray-900 dark:text-white">Roberta Casas</div>
                              <div className="text-sm font-normal text-gray-500 dark:text-gray-400">roberta.casas@flowbite.com</div>
                            </div>
                          </td>
                        ...
                        <tr className="hover:bg-gray-100 dark:hover:bg-gray-700">
                          ...
                          <td className="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap">
                            <img
                              className="w-10 h-10 rounded-full"
                              src="http://localhost:1313/images/users/michael-gough.png"
                              alt="Michael Gough avatar"
                            />
                            <div className="text-sm font-normal text-gray-500 dark:text-gray-400">
                              <div className="text-base font-semibold text-gray-900 dark:text-white">Michael Gough</div>
                              <div className="text-sm font-normal text-gray-500 dark:text-gray-400">michael.gough@flowbite.com</div>
                            </div>
                          </td>
                        ...
                        <tr className="hover:bg-gray-100 dark:hover:bg-gray-700">
                          ...
                          <td className="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap">
                            ...
                            />
                            <div className="text-sm font-normal text-gray-500 dark:text-gray-400">
                              <div className="text-base font-semibold text-gray-900 dark:text-white">Jese Leos</div>
                              <div className="text-sm font-normal text-gray-500 dark:text-gray-400">jese.leos@flowbite.com</div>
                            </div>
                          </td>
                        ...
                        <tr className="hover:bg-gray-100 dark:hover:bg-gray-700">
                          ...
                          <td className="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap">
                            ...
                            />
                            <div className="text-sm font-normal text-gray-500 dark:text-gray-400">
                              <div className="text-base font-semibold text-gray-900 dark:text-white">Bonnie Green</div>
                              <div className="text-sm font-normal text-gray-500 dark:text-gray-400">bonnie.green@flowbite.com</div>
                            </div>
                          </td>
                        ...
                        <tr className="hover:bg-gray-100 dark:hover:bg-gray-700">
                          ...
                          <td className="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap">
                            <img
                              className="w-10 h-10 rounded-full"
                              src="http://localhost:1313/images/users/thomas-lean.png"
                              alt="Thomas Lean avatar"
                            />
                            <div className="text-sm font-normal text-gray-500 dark:text-gray-400">
                              <div className="text-base font-semibold text-gray-900 dark:text-white">Thomas Lean</div>
                              <div className="text-sm font-normal text-gray-500 dark:text-gray-400">thomas.lean@flowbite.com</div>
                            </div>
                          </td>
                        ...
                        <tr className="hover:bg-gray-100 dark:hover:bg-gray-700">
                          ...
                          <td className="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap">
                            <img
                              className="w-10 h-10 rounded-full"
                              src="http://localhost:1313/images/users/helene-engels.png"
                              alt="Helene Engels avatar"
                            />
                            <div className="text-sm font-normal text-gray-500 dark:text-gray-400">
                              <div className="text-base font-semibold text-gray-900 dark:text-white">Helene Engels</div>
                              <div className="text-sm font-normal text-gray-500 dark:text-gray-400">helene.engels@flowbite.com</div>
                            </div>
                          </td>
                        ...
                        <tr className="hover:bg-gray-100 dark:hover:bg-gray-700">
                          ...
                          <td className="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap">
                            ...
                            />
                            <div className="text-sm font-normal text-gray-500 dark:text-gray-400">
                              <div className="text-base font-semibold text-gray-900 dark:text-white">Lana Byrd</div>
                              <div className="text-sm font-normal text-gray-500 dark:text-gray-400">lana.byrd@flowbite.com</div>
                            </div>
                          </td>
                        ...
                        <tr className="hover:bg-gray-100 dark:hover:bg-gray-700">
                          ...
                          <td className="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap">
                            ...
                            />
                            <div className="text-sm font-normal text-gray-500 dark:text-gray-400">
                              <div className="text-base font-semibold text-gray-900 dark:text-white">Leslie Livingston</div>
                              <div className="text-sm font-normal text-gray-500 dark:text-gray-400">leslie.livingston@flowbite.com</div>
                            </div>
                          </td>
                        ...
                        <tr className="hover:bg-gray-100 dark:hover:bg-gray-700">
                          ...
                          <td className="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap">
                            ...
                            <div className="text-sm font-normal text-gray-500 dark:text-gray-400">
                              ...
                              <div className="text-sm font-normal text-gray-500 dark:text-gray-400">robert.brown@flowbite.com</div>
                            </div>
                          </td>
              ...
              <div className="relative w-full h-full max-w-2xl px-4 md:h-auto">
                ...
                <div className="relative bg-white rounded-lg shadow dark:bg-gray-800">
                  ...
                  <div className="flex items-start justify-between p-5 border-b rounded-t dark:border-gray-700">
                    <h3 className="text-xl font-semibold dark:text-white">Accepte</h3>
                    <button
                      type="button"
